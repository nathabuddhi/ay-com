...
const (
	...
	EmailService_SendNotificationEmail_FullMethodName = "/email.EmailService/SendNotificationEmail"
)
...
type EmailServiceClient interface {
	...
	SendNotificationEmail(ctx context.Context, in *SendNotificationEmailRequest, opts ...grpc.CallOption) (*SendNotificationEmailResponse, error)
}
...
func (c *emailServiceClient) SendNotificationEmail(ctx context.Context, in *SendNotificationEmailRequest, opts ...grpc.CallOption) (*SendNotificationEmailResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SendNotificationEmailResponse)
	err := c.cc.Invoke(ctx, EmailService_SendNotificationEmail_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type EmailServiceServer interface {
	...
	SendNotificationEmail(context.Context, *SendNotificationEmailRequest) (*SendNotificationEmailResponse, error)
...
func (UnimplementedEmailServiceServer) SendNotificationEmail(context.Context, *SendNotificationEmailRequest) (*SendNotificationEmailResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SendNotificationEmail not implemented")
}
...
func _EmailService_SendNotificationEmail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SendNotificationEmailRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(EmailServiceServer).SendNotificationEmail(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: EmailService_SendNotificationEmail_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(EmailServiceServer).SendNotificationEmail(ctx, req.(*SendNotificationEmailRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var EmailService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "SendNotificationEmail",
			Handler:    _EmailService_SendNotificationEmail_Handler,
		},
	},
